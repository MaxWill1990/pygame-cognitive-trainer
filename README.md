...
O sistema conta com três módulos principais de treinamento, desenhados para gerar pressão de tempo e testar reflexos:

* **🧩 Lógica Espacial (Blocos):** Avalia o raciocínio geométrico e a capacidade de resolução de quebra-cabeças visuais contra o relógio.
* **⏱️ Atenção Concentrada (Bolhas):** Um modo de sobrevivência de raciocínio lógico-matemático. O usuário precisa calcular operações e clicar nas respostas certas sob forte restrição de tempo.
* **🇬🇧 Inglês Técnico Corporativo (Syntax Hacker):** Vai além da tradução. Testa a atenção visual do candidato para encontrar erros de ortografia (typos), preposições e falsos cognatos em e-mails e documentações técnicas.

## 🚀 Como executar o projeto localmente

Para rodar o simulador na sua máquina, certifique-se de ter o Python instalado.

1. Clone este repositório:
   ```bash
   git clone [https://github.com/seu-usuario/pygame-cognitive-trainer.git](https://github.com/seu-usuario/pygame-cognitive-trainer.git)
